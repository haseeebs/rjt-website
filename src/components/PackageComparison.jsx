                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <select
                                className="block w-full pl-4 pr-8 py-3 text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white appearance-none"
                                value={selectedDays}
                            ...
                            <div className="flex space-x-1">
                                {['details', 'inclusions'].map((tab) => (
                                    <button
                                        ...
                                        className={`flex-1 px-4 py-2.5 text-sm font-medium rounded-md transition-all duration-200 ${activeTab === tab
                    ...
                    <table className="w-full">
                        <thead className="sticky top-0 bg-white z-10">
                            <tr className="border-b border-gray-200">
                                <th className="px-6 py-4 bg-gray-50 text-left text-sm font-semibold text-gray-900">Category</th>
                                {activeTab === 'details' ? (
                                    <>
                                        <th className="px-6 py-4 bg-gray-50 text-left text-sm font-semibold text-gray-900">Price</th>
                                        <th className="px-6 py-4 bg-gray-50 text-left text-sm font-semibold text-gray-900">Makkah Hotel</th>
                                        <th className="px-6 py-4 bg-gray-50 text-left text-sm font-semibold text-gray-900">Madinah Hotel</th>
                                    </>
                                ) : (
                                    <th className="px-6 py-4 bg-gray-50 text-left text-sm font-semibold text-gray-900">Package Inclusions</th>
                                )}
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-200">
                            {categories.map((category) => {
                                ...
                                return (
                                    <tr key={category} className="hover:bg-gray-50 transition-colors duration-150">
